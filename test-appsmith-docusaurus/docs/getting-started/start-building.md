...
![Creating a new application on Appsmith](/img/Screenshot2022-07-21at11.49.02AM.png)
...
![Creating a new datasource](/img/AddDatasource.png)
...
Now that you have created your first Appsmith application, you may be wondering what to learn next. The Quickstart covered only the basic concepts. There's so much more to explore, so head over to the [**next steps**](/docs/intro.md#advanced-users).
